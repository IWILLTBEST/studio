...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.2.2/../common/pre.js
...
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.2.2/../common/pre.js
...
var ASM_CONSTS = {
  1185384: ($0) => { startToDebuggerMessage($0); },  
 1185416: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185491: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185566: ($0) => { finishToDebuggerMessage($0); },  
 1185599: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1185629: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1185659: ($0) => { lvglScreenTick($0); },  
 1185683: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1185723: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1185777: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1185831: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1185884: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1185937: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1185990: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186042: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186089: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186122: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186158: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186203: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186309: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186345: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186382: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186422: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186479: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186538: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
...
function assignWasmExports(wasmExports) {
  ...
  _lv_slider_set_left_value = Module['_lv_slider_set_left_value'] = createExportWrapper('lv_slider_set_left_value', wasmExports['lv_slider_set_left_value'], 3);
  ...
  _lv_calendar_header_arrow_create = Module['_lv_calendar_header_arrow_create'] = createExportWrapper('lv_calendar_header_arrow_create', wasmExports['lv_calendar_header_arrow_create'], 1);
  _lv_calendar_set_showed_date = Module['_lv_calendar_set_showed_date'] = createExportWrapper('lv_calendar_set_showed_date', wasmExports['lv_calendar_set_showed_date'], 3);
  ...
  _lv_obj_update_flag = Module['_lv_obj_update_flag'] = createExportWrapper('lv_obj_update_flag', wasmExports['lv_obj_update_flag'], 3);
  ...
  _lv_draw_add_task = Module['_lv_draw_add_task'] = createExportWrapper('lv_draw_add_task', wasmExports['lv_draw_add_task'], 2);
  ...
  _lv_text_get_next_line = Module['_lv_text_get_next_line'] = createExportWrapper('lv_text_get_next_line', wasmExports['lv_text_get_next_line'], 6);
  ...
  _lv_gradient_get = Module['_lv_gradient_get'] = createExportWrapper('lv_gradient_get', wasmExports['lv_gradient_get'], 3);
  _lv_gradient_color_calculate = Module['_lv_gradient_color_calculate'] = createExportWrapper('lv_gradient_color_calculate', wasmExports['lv_gradient_color_calculate'], 5);
  _lv_gradient_cleanup = Module['_lv_gradient_cleanup'] = createExportWrapper('lv_gradient_cleanup', wasmExports['lv_gradient_cleanup'], 1);
  _lv_gradient_init_stops = Module['_lv_gradient_init_stops'] = createExportWrapper('lv_gradient_init_stops', wasmExports['lv_gradient_init_stops'], 5);
  ...
  _lv_mutex_init = Module['_lv_mutex_init'] = createExportWrapper('lv_mutex_init', wasmExports['lv_mutex_init'], 1);
  _lv_mutex_delete = Module['_lv_mutex_delete'] = createExportWrapper('lv_mutex_delete', wasmExports['lv_mutex_delete'], 1);
  _lv_mutex_lock = Module['_lv_mutex_lock'] = createExportWrapper('lv_mutex_lock', wasmExports['lv_mutex_lock'], 1);
  _lv_mutex_unlock = Module['_lv_mutex_unlock'] = createExportWrapper('lv_mutex_unlock', wasmExports['lv_mutex_unlock'], 1);
  ...
  _lv_draw_sw_mask_rect = Module['_lv_draw_sw_mask_rect'] = createExportWrapper('lv_draw_sw_mask_rect', wasmExports['lv_draw_sw_mask_rect'], 3);
  _lv_draw_sw_transform = Module['_lv_draw_sw_transform'] = createExportWrapper('lv_draw_sw_transform', wasmExports['lv_draw_sw_transform'], 10);
  ...
  _lv_font_default = Module['_lv_font_default'] = createExportWrapper('lv_font_default', wasmExports['lv_font_default'], 0);
  ...
  _lv_anim_set_time = Module['_lv_anim_set_time'] = createExportWrapper('lv_anim_set_time', wasmExports['lv_anim_set_time'], 2);
  ...
  _lv_anim_set_playback_duration = Module['_lv_anim_set_playback_duration'] = createExportWrapper('lv_anim_set_playback_duration', wasmExports['lv_anim_set_playback_duration'], 2);
  _lv_anim_set_playback_time = Module['_lv_anim_set_playback_time'] = createExportWrapper('lv_anim_set_playback_time', wasmExports['lv_anim_set_playback_time'], 2);
  _lv_anim_set_playback_delay = Module['_lv_anim_set_playback_delay'] = createExportWrapper('lv_anim_set_playback_delay', wasmExports['lv_anim_set_playback_delay'], 2);
  ...
  _lv_array_is_empty = Module['_lv_array_is_empty'] = createExportWrapper('lv_array_is_empty', wasmExports['lv_array_is_empty'], 1);
  ...
  _lv_array_size = Module['_lv_array_size'] = createExportWrapper('lv_array_size', wasmExports['lv_array_size'], 1);
  _lv_array_capacity = Module['_lv_array_capacity'] = createExportWrapper('lv_array_capacity', wasmExports['lv_array_capacity'], 1);
  _lv_array_is_full = Module['_lv_array_is_full'] = createExportWrapper('lv_array_is_full', wasmExports['lv_array_is_full'], 1);
  _lv_array_clear = Module['_lv_array_clear'] = createExportWrapper('lv_array_clear', wasmExports['lv_array_clear'], 1);
  _lv_array_front = Module['_lv_array_front'] = createExportWrapper('lv_array_front', wasmExports['lv_array_front'], 1);
  _lv_array_back = Module['_lv_array_back'] = createExportWrapper('lv_array_back', wasmExports['lv_array_back'], 1);
  ...
  _lv_thread_init = Module['_lv_thread_init'] = createExportWrapper('lv_thread_init', wasmExports['lv_thread_init'], 5);
  _lv_thread_delete = Module['_lv_thread_delete'] = createExportWrapper('lv_thread_delete', wasmExports['lv_thread_delete'], 1);
  _lv_mutex_lock_isr = Module['_lv_mutex_lock_isr'] = createExportWrapper('lv_mutex_lock_isr', wasmExports['lv_mutex_lock_isr'], 1);
  _lv_thread_sync_init = Module['_lv_thread_sync_init'] = createExportWrapper('lv_thread_sync_init', wasmExports['lv_thread_sync_init'], 1);
  _lv_thread_sync_wait = Module['_lv_thread_sync_wait'] = createExportWrapper('lv_thread_sync_wait', wasmExports['lv_thread_sync_wait'], 1);
  _lv_thread_sync_signal = Module['_lv_thread_sync_signal'] = createExportWrapper('lv_thread_sync_signal', wasmExports['lv_thread_sync_signal'], 1);
  _lv_thread_sync_signal_isr = Module['_lv_thread_sync_signal_isr'] = createExportWrapper('lv_thread_sync_signal_isr', wasmExports['lv_thread_sync_signal_isr'], 1);
  _lv_thread_sync_delete = Module['_lv_thread_sync_delete'] = createExportWrapper('lv_thread_sync_delete', wasmExports['lv_thread_sync_delete'], 1);
  ...
  _lv_calendar_header_dropdown_create = Module['_lv_calendar_header_dropdown_create'] = createExportWrapper('lv_calendar_header_dropdown_create', wasmExports['lv_calendar_header_dropdown_create'], 1);
  ...
  _lv_chart_set_range = Module['_lv_chart_set_range'] = createExportWrapper('lv_chart_set_range', wasmExports['lv_chart_set_range'], 4);
  ...
  _lv_chart_set_all_value = Module['_lv_chart_set_all_value'] = createExportWrapper('lv_chart_set_all_value', wasmExports['lv_chart_set_all_value'], 3);
  ...
  _lv_chart_set_value_by_id = Module['_lv_chart_set_value_by_id'] = createExportWrapper('lv_chart_set_value_by_id', wasmExports['lv_chart_set_value_by_id'], 4);
  _lv_chart_set_value_by_id2 = Module['_lv_chart_set_value_by_id2'] = createExportWrapper('lv_chart_set_value_by_id2', wasmExports['lv_chart_set_value_by_id2'], 5);
  _lv_chart_set_ext_y_array = Module['_lv_chart_set_ext_y_array'] = createExportWrapper('lv_chart_set_ext_y_array', wasmExports['lv_chart_set_ext_y_array'], 3);
  _lv_chart_set_ext_x_array = Module['_lv_chart_set_ext_x_array'] = createExportWrapper('lv_chart_set_ext_x_array', wasmExports['lv_chart_set_ext_x_array'], 3);
  _lv_chart_get_y_array = Module['_lv_chart_get_y_array'] = createExportWrapper('lv_chart_get_y_array', wasmExports['lv_chart_get_y_array'], 2);
  _lv_chart_get_x_array = Module['_lv_chart_get_x_array'] = createExportWrapper('lv_chart_get_x_array', wasmExports['lv_chart_get_x_array'], 2);
  ...
  _lv_spangroup_new_span = Module['_lv_spangroup_new_span'] = createExportWrapper('lv_spangroup_new_span', wasmExports['lv_spangroup_new_span'], 1);
  ...
  _lv_spangroup_refr_mode = Module['_lv_spangroup_refr_mode'] = createExportWrapper('lv_spangroup_refr_mode', wasmExports['lv_spangroup_refr_mode'], 1);
  ...
  _lv_table_add_cell_ctrl = Module['_lv_table_add_cell_ctrl'] = createExportWrapper('lv_table_add_cell_ctrl', wasmExports['lv_table_add_cell_ctrl'], 4);
...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.2.2/../common/post.js
}
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.2.2/../common/post.js
