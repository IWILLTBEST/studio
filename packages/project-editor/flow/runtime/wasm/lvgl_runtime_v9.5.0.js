...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/pre.js
...
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/pre.js
...
function assignWasmExports(wasmExports) {
  ...
  _lv_freetype_font_create = Module['_lv_freetype_font_create'] = createExportWrapper('lv_freetype_font_create', wasmExports['lv_freetype_font_create'], 4);
  ...
  _lv_group_set_user_data = Module['_lv_group_set_user_data'] = createExportWrapper('lv_group_set_user_data', wasmExports['lv_group_set_user_data'], 2);
  _lv_group_get_user_data = Module['_lv_group_get_user_data'] = createExportWrapper('lv_group_get_user_data', wasmExports['lv_group_get_user_data'], 1);
  ...
  _lv_obj_is_radio_button = Module['_lv_obj_is_radio_button'] = createExportWrapper('lv_obj_is_radio_button', wasmExports['lv_obj_is_radio_button'], 1);
  ...
  _lv_draw_blur_dsc_init = Module['_lv_draw_blur_dsc_init'] = createExportWrapper('lv_draw_blur_dsc_init', wasmExports['lv_draw_blur_dsc_init'], 1);
  _lv_obj_init_draw_blur_dsc = Module['_lv_obj_init_draw_blur_dsc'] = createExportWrapper('lv_obj_init_draw_blur_dsc', wasmExports['lv_obj_init_draw_blur_dsc'], 3);
  _lv_draw_blur = Module['_lv_draw_blur'] = createExportWrapper('lv_draw_blur', wasmExports['lv_draw_blur'], 3);
  ...
  _lv_obj_set_radio_button = Module['_lv_obj_set_radio_button'] = createExportWrapper('lv_obj_set_radio_button', wasmExports['lv_obj_set_radio_button'], 2);
  ...
  _lv_obj_add_screen_load_event = Module['_lv_obj_add_screen_load_event'] = createExportWrapper('lv_obj_add_screen_load_event', wasmExports['lv_obj_add_screen_load_event'], 6);
  _lv_memset = Module['_lv_memset'] = createExportWrapper('lv_memset', wasmExports['lv_memset'], 3);
  _lv_event_free_user_data_cb = Module['_lv_event_free_user_data_cb'] = createExportWrapper('lv_event_free_user_data_cb', wasmExports['lv_event_free_user_data_cb'], 1);
  _lv_obj_add_screen_create_event = Module['_lv_obj_add_screen_create_event'] = createExportWrapper('lv_obj_add_screen_create_event', wasmExports['lv_obj_add_screen_create_event'], 6);
  _lv_obj_add_play_timeline_event = Module['_lv_obj_add_play_timeline_event'] = createExportWrapper('lv_obj_add_play_timeline_event', wasmExports['lv_obj_add_play_timeline_event'], 5);
  ...
  _lv_anim_timeline_set_delay = Module['_lv_anim_timeline_set_delay'] = createExportWrapper('lv_anim_timeline_set_delay', wasmExports['lv_anim_timeline_set_delay'], 2);
  ...
  _lv_event_get_prev_state = Module['_lv_event_get_prev_state'] = createExportWrapper('lv_event_get_prev_state', wasmExports['lv_event_get_prev_state'], 1);
  ...
  _lv_obj_calc_dynamic_width = Module['_lv_obj_calc_dynamic_width'] = createExportWrapper('lv_obj_calc_dynamic_width', wasmExports['lv_obj_calc_dynamic_width'], 2);
  ...
  _lv_obj_calc_dynamic_height = Module['_lv_obj_calc_dynamic_height'] = createExportWrapper('lv_obj_calc_dynamic_height', wasmExports['lv_obj_calc_dynamic_height'], 2);
  ...
  _lv_obj_get_style_clamped_width = Module['_lv_obj_get_style_clamped_width'] = createExportWrapper('lv_obj_get_style_clamped_width', wasmExports['lv_obj_get_style_clamped_width'], 1);
  _lv_obj_get_style_clamped_height = Module['_lv_obj_get_style_clamped_height'] = createExportWrapper('lv_obj_get_style_clamped_height', wasmExports['lv_obj_get_style_clamped_height'], 1);
  _lv_obj_is_width_min = Module['_lv_obj_is_width_min'] = createExportWrapper('lv_obj_is_width_min', wasmExports['lv_obj_is_width_min'], 1);
  _lv_obj_is_height_min = Module['_lv_obj_is_height_min'] = createExportWrapper('lv_obj_is_height_min', wasmExports['lv_obj_is_height_min'], 1);
  _lv_obj_is_width_max = Module['_lv_obj_is_width_max'] = createExportWrapper('lv_obj_is_width_max', wasmExports['lv_obj_is_width_max'], 1);
  _lv_obj_is_height_max = Module['_lv_obj_is_height_max'] = createExportWrapper('lv_obj_is_height_max', wasmExports['lv_obj_is_height_max'], 1);
  ...
  _lv_layout_get_min_size = Module['_lv_layout_get_min_size'] = createExportWrapper('lv_layout_get_min_size', wasmExports['lv_layout_get_min_size'], 3);
  ...
  _lv_obj_remove_theme = Module['_lv_obj_remove_theme'] = createExportWrapper('lv_obj_remove_theme', wasmExports['lv_obj_remove_theme'], 2);
  ...
  _lv_obj_style_set_disabled = Module['_lv_obj_style_set_disabled'] = createExportWrapper('lv_obj_style_set_disabled', wasmExports['lv_obj_style_set_disabled'], 4);
  _lv_obj_style_get_disabled = Module['_lv_obj_style_get_disabled'] = createExportWrapper('lv_obj_style_get_disabled', wasmExports['lv_obj_style_get_disabled'], 3);
  ...
  _lv_obj_bind_style = Module['_lv_obj_bind_style'] = createExportWrapper('lv_obj_bind_style', wasmExports['lv_obj_bind_style'], 5);
  ...
  _lv_obj_bind_style_prop = Module['_lv_obj_bind_style_prop'] = createExportWrapper('lv_obj_bind_style_prop', wasmExports['lv_obj_bind_style_prop'], 4);
  ...
  _lv_obj_set_style_image_colorkey = Module['_lv_obj_set_style_image_colorkey'] = createExportWrapper('lv_obj_set_style_image_colorkey', wasmExports['lv_obj_set_style_image_colorkey'], 3);
  ...
  _lv_obj_set_style_blur_radius = Module['_lv_obj_set_style_blur_radius'] = createExportWrapper('lv_obj_set_style_blur_radius', wasmExports['lv_obj_set_style_blur_radius'], 3);
  _lv_obj_set_style_blur_backdrop = Module['_lv_obj_set_style_blur_backdrop'] = createExportWrapper('lv_obj_set_style_blur_backdrop', wasmExports['lv_obj_set_style_blur_backdrop'], 3);
  _lv_obj_set_style_blur_quality = Module['_lv_obj_set_style_blur_quality'] = createExportWrapper('lv_obj_set_style_blur_quality', wasmExports['lv_obj_set_style_blur_quality'], 3);
  _lv_obj_set_style_drop_shadow_radius = Module['_lv_obj_set_style_drop_shadow_radius'] = createExportWrapper('lv_obj_set_style_drop_shadow_radius', wasmExports['lv_obj_set_style_drop_shadow_radius'], 3);
  _lv_obj_set_style_drop_shadow_offset_x = Module['_lv_obj_set_style_drop_shadow_offset_x'] = createExportWrapper('lv_obj_set_style_drop_shadow_offset_x', wasmExports['lv_obj_set_style_drop_shadow_offset_x'], 3);
  _lv_obj_set_style_drop_shadow_offset_y = Module['_lv_obj_set_style_drop_shadow_offset_y'] = createExportWrapper('lv_obj_set_style_drop_shadow_offset_y', wasmExports['lv_obj_set_style_drop_shadow_offset_y'], 3);
  _lv_obj_set_style_drop_shadow_color = Module['_lv_obj_set_style_drop_shadow_color'] = createExportWrapper('lv_obj_set_style_drop_shadow_color', wasmExports['lv_obj_set_style_drop_shadow_color'], 3);
  _lv_obj_set_style_drop_shadow_opa = Module['_lv_obj_set_style_drop_shadow_opa'] = createExportWrapper('lv_obj_set_style_drop_shadow_opa', wasmExports['lv_obj_set_style_drop_shadow_opa'], 3);
  _lv_obj_set_style_drop_shadow_quality = Module['_lv_obj_set_style_drop_shadow_quality'] = createExportWrapper('lv_obj_set_style_drop_shadow_quality', wasmExports['lv_obj_set_style_drop_shadow_quality'], 3);
  ...
  _lv_subject_set_min_value_int = Module['_lv_subject_set_min_value_int'] = createExportWrapper('lv_subject_set_min_value_int', wasmExports['lv_subject_set_min_value_int'], 2);
  _lv_subject_set_max_value_int = Module['_lv_subject_set_max_value_int'] = createExportWrapper('lv_subject_set_max_value_int', wasmExports['lv_subject_set_max_value_int'], 2);
  ...
  _lv_obj_add_subject_increment_event = Module['_lv_obj_add_subject_increment_event'] = createExportWrapper('lv_obj_add_subject_increment_event', wasmExports['lv_obj_add_subject_increment_event'], 4);
  _lv_obj_set_subject_increment_event_min_value = Module['_lv_obj_set_subject_increment_event_min_value'] = createExportWrapper('lv_obj_set_subject_increment_event_min_value', wasmExports['lv_obj_set_subject_increment_event_min_value'], 3);
  _lv_obj_set_subject_increment_event_max_value = Module['_lv_obj_set_subject_increment_event_max_value'] = createExportWrapper('lv_obj_set_subject_increment_event_max_value', wasmExports['lv_obj_set_subject_increment_event_max_value'], 3);
  _lv_obj_set_subject_increment_event_rollover = Module['_lv_obj_set_subject_increment_event_rollover'] = createExportWrapper('lv_obj_set_subject_increment_event_rollover', wasmExports['lv_obj_set_subject_increment_event_rollover'], 3);
  _lv_obj_add_subject_toggle_event = Module['_lv_obj_add_subject_toggle_event'] = createExportWrapper('lv_obj_add_subject_toggle_event', wasmExports['lv_obj_add_subject_toggle_event'], 3);
  _lv_obj_add_subject_set_int_event = Module['_lv_obj_add_subject_set_int_event'] = createExportWrapper('lv_obj_add_subject_set_int_event', wasmExports['lv_obj_add_subject_set_int_event'], 4);
  _lv_obj_add_subject_set_string_event = Module['_lv_obj_add_subject_set_string_event'] = createExportWrapper('lv_obj_add_subject_set_string_event', wasmExports['lv_obj_add_subject_set_string_event'], 4);
  ...
  _lv_obj_refr = Module['_lv_obj_refr'] = createExportWrapper('lv_obj_refr', wasmExports['lv_obj_refr'], 2);
  ...
  _lv_refr_get_top_obj = Module['_lv_refr_get_top_obj'] = createExportWrapper('lv_refr_get_top_obj', wasmExports['lv_refr_get_top_obj'], 2);
  ...
  _lv_draw_unit_send_event = Module['_lv_draw_unit_send_event'] = createExportWrapper('lv_draw_unit_send_event', wasmExports['lv_draw_unit_send_event'], 3);
  ...
  _lv_event_push_and_send = Module['_lv_event_push_and_send'] = createExportWrapper('lv_event_push_and_send', wasmExports['lv_event_push_and_send'], 4);
  ...
  _lv_display_get_render_mode = Module['_lv_display_get_render_mode'] = createExportWrapper('lv_display_get_render_mode', wasmExports['lv_display_get_render_mode'], 1);
  ...
  _lv_display_get_screen_loading = Module['_lv_display_get_screen_loading'] = createExportWrapper('lv_display_get_screen_loading', wasmExports['lv_display_get_screen_loading'], 1);
  ...
  _lv_display_rotate_point = Module['_lv_display_rotate_point'] = createExportWrapper('lv_display_rotate_point', wasmExports['lv_display_rotate_point'], 2);
  ...
  _lv_draw_buf_convert_premultiply = Module['_lv_draw_buf_convert_premultiply'] = createExportWrapper('lv_draw_buf_convert_premultiply', wasmExports['lv_draw_buf_convert_premultiply'], 1);
  ...
  _lv_draw_layer_create_drop_shadow = Module['_lv_draw_layer_create_drop_shadow'] = createExportWrapper('lv_draw_layer_create_drop_shadow', wasmExports['lv_draw_layer_create_drop_shadow'], 3);
  _lv_draw_layer_finish_drop_shadow = Module['_lv_draw_layer_finish_drop_shadow'] = createExportWrapper('lv_draw_layer_finish_drop_shadow', wasmExports['lv_draw_layer_finish_drop_shadow'], 2);
  ...
  _lv_draw_task_get_blur_dsc = Module['_lv_draw_task_get_blur_dsc'] = createExportWrapper('lv_draw_task_get_blur_dsc', wasmExports['lv_draw_task_get_blur_dsc'], 1);
  ...
  _lv_draw_buf_handlers_init = Module['_lv_draw_buf_handlers_init'] = createExportWrapper('lv_draw_buf_handlers_init', wasmExports['lv_draw_buf_handlers_init'], 8);
  ...
  _lv_draw_image_normal_helper = Module['_lv_draw_image_normal_helper'] = createExportWrapper('lv_draw_image_normal_helper', wasmExports['lv_draw_image_normal_helper'], 5);
  ...
  _lv_draw_image_tiled_helper = Module['_lv_draw_image_tiled_helper'] = createExportWrapper('lv_draw_image_tiled_helper', wasmExports['lv_draw_image_tiled_helper'], 5);
  ...
  _lv_text_get_size_attributes = Module['_lv_text_get_size_attributes'] = createExportWrapper('lv_text_get_size_attributes', wasmExports['lv_text_get_size_attributes'], 4);
  _lv_point_set = Module['_lv_point_set'] = createExportWrapper('lv_point_set', wasmExports['lv_point_set'], 3);
  _lv_text_get_next_line = Module['_lv_text_get_next_line'] = createExportWrapper('lv_text_get_next_line', wasmExports['lv_text_get_next_line'], 5);
  ...
  _lv_draw_line_iterate = Module['_lv_draw_line_iterate'] = createExportWrapper('lv_draw_line_iterate', wasmExports['lv_draw_line_iterate'], 3);
  ...
  _lv_draw_sw_blend_color_to_a8 = Module['_lv_draw_sw_blend_color_to_a8'] = createExportWrapper('lv_draw_sw_blend_color_to_a8', wasmExports['lv_draw_sw_blend_color_to_a8'], 1);
  _lv_draw_sw_blend_image_to_a8 = Module['_lv_draw_sw_blend_image_to_a8'] = createExportWrapper('lv_draw_sw_blend_image_to_a8', wasmExports['lv_draw_sw_blend_image_to_a8'], 1);
  ...
  _lv_draw_sw_blur = Module['_lv_draw_sw_blur'] = createExportWrapper('lv_draw_sw_blur', wasmExports['lv_draw_sw_blur'], 3);
  ...
  _lv_tick_diff = Module['_lv_tick_diff'] = createExportWrapper('lv_tick_diff', wasmExports['lv_tick_diff'], 2);
  ...
  _lv_indev_set_gesture_min_distance = Module['_lv_indev_set_gesture_min_distance'] = createExportWrapper('lv_indev_set_gesture_min_distance', wasmExports['lv_indev_set_gesture_min_distance'], 2);
  _lv_indev_set_gesture_min_velocity = Module['_lv_indev_set_gesture_min_velocity'] = createExportWrapper('lv_indev_set_gesture_min_velocity', wasmExports['lv_indev_set_gesture_min_velocity'], 2);
  ...
  _lv_indev_set_key_remap_cb = Module['_lv_indev_set_key_remap_cb'] = createExportWrapper('lv_indev_set_key_remap_cb', wasmExports['lv_indev_set_key_remap_cb'], 2);
  ...
  _lv_layout_create = Module['_lv_layout_create'] = createExportWrapper('lv_layout_create', wasmExports['lv_layout_create'], 2);
  ...
  _lv_freetype_font_create_with_info = Module['_lv_freetype_font_create_with_info'] = createExportWrapper('lv_freetype_font_create_with_info', wasmExports['lv_freetype_font_create_with_info'], 1);
  _lv_freetype_font_delete = Module['_lv_freetype_font_delete'] = createExportWrapper('lv_freetype_font_delete', wasmExports['lv_freetype_font_delete'], 1);
  _lv_freetype_init = Module['_lv_freetype_init'] = createExportWrapper('lv_freetype_init', wasmExports['lv_freetype_init'], 1);
  _lv_freetype_get_context = Module['_lv_freetype_get_context'] = createExportWrapper('lv_freetype_get_context', wasmExports['lv_freetype_get_context'], 0);
  _lv_freetype_uninit = Module['_lv_freetype_uninit'] = createExportWrapper('lv_freetype_uninit', wasmExports['lv_freetype_uninit'], 0);
  _lv_freetype_init_font_info = Module['_lv_freetype_init_font_info'] = createExportWrapper('lv_freetype_init_font_info', wasmExports['lv_freetype_init_font_info'], 1);
  ...
  _lv_freetype_create_glyph_cache = Module['_lv_freetype_create_glyph_cache'] = createExportWrapper('lv_freetype_create_glyph_cache', wasmExports['lv_freetype_create_glyph_cache'], 1);
  _lv_freetype_create_draw_data_outline = Module['_lv_freetype_create_draw_data_outline'] = createExportWrapper('lv_freetype_create_draw_data_outline', wasmExports['lv_freetype_create_draw_data_outline'], 1);
  _lv_freetype_create_draw_data_image = Module['_lv_freetype_create_draw_data_image'] = createExportWrapper('lv_freetype_create_draw_data_image', wasmExports['lv_freetype_create_draw_data_image'], 1);
  _lv_freetype_set_cbs_glyph = Module['_lv_freetype_set_cbs_glyph'] = createExportWrapper('lv_freetype_set_cbs_glyph', wasmExports['lv_freetype_set_cbs_glyph'], 1);
  _lv_freetype_set_cbs_image_font = Module['_lv_freetype_set_cbs_image_font'] = createExportWrapper('lv_freetype_set_cbs_image_font', wasmExports['lv_freetype_set_cbs_image_font'], 1);
  _lv_freetype_set_cbs_outline_font = Module['_lv_freetype_set_cbs_outline_font'] = createExportWrapper('lv_freetype_set_cbs_outline_font', wasmExports['lv_freetype_set_cbs_outline_font'], 1);
  ...
  _lv_freetype_italic_transform = Module['_lv_freetype_italic_transform'] = createExportWrapper('lv_freetype_italic_transform', wasmExports['lv_freetype_italic_transform'], 1);
  _lv_freetype_italic_transform_on_pos = Module['_lv_freetype_italic_transform_on_pos'] = createExportWrapper('lv_freetype_italic_transform_on_pos', wasmExports['lv_freetype_italic_transform_on_pos'], 1);
  _lv_freetype_outline_add_event = Module['_lv_freetype_outline_add_event'] = createExportWrapper('lv_freetype_outline_add_event', wasmExports['lv_freetype_outline_add_event'], 3);
  _lv_freetype_outline_get_scale = Module['_lv_freetype_outline_get_scale'] = createExportWrapper('lv_freetype_outline_get_scale', wasmExports['lv_freetype_outline_get_scale'], 1);
  _lv_freetype_is_outline_font = Module['_lv_freetype_is_outline_font'] = createExportWrapper('lv_freetype_is_outline_font', wasmExports['lv_freetype_is_outline_font'], 1);
  ...
  _lv_qrcode_set_data = Module['_lv_qrcode_set_data'] = createExportWrapper('lv_qrcode_set_data', wasmExports['lv_qrcode_set_data'], 2);
  _lv_qrcode_set_quiet_zone = Module['_lv_qrcode_set_quiet_zone'] = createExportWrapper('lv_qrcode_set_quiet_zone', wasmExports['lv_qrcode_set_quiet_zone'], 2);
  ...
  _lv_deinit = Module['_lv_deinit'] = createExportWrapper('lv_deinit', wasmExports['lv_deinit'], 0);
  ...
  _lv_cache_entry_set_flag = Module['_lv_cache_entry_set_flag'] = createExportWrapper('lv_cache_entry_set_flag', wasmExports['lv_cache_entry_set_flag'], 2);
  ...
  _lv_cache_entry_remove_flag = Module['_lv_cache_entry_remove_flag'] = createExportWrapper('lv_cache_entry_remove_flag', wasmExports['lv_cache_entry_remove_flag'], 2);
  _lv_cache_entry_has_flag = Module['_lv_cache_entry_has_flag'] = createExportWrapper('lv_cache_entry_has_flag', wasmExports['lv_cache_entry_has_flag'], 2);
  _lv_anim_delete_all = Module['_lv_anim_delete_all'] = createExportWrapper('lv_anim_delete_all', wasmExports['lv_anim_delete_all'], 0);
  _lv_anim_enable_vsync_mode = Module['_lv_anim_enable_vsync_mode'] = createExportWrapper('lv_anim_enable_vsync_mode', wasmExports['lv_anim_enable_vsync_mode'], 1);
  ...
  _lv_anim_timeline_set_user_data = Module['_lv_anim_timeline_set_user_data'] = createExportWrapper('lv_anim_timeline_set_user_data', wasmExports['lv_anim_timeline_set_user_data'], 2);
  ...
  _lv_anim_timeline_get_delay = Module['_lv_anim_timeline_get_delay'] = createExportWrapper('lv_anim_timeline_get_delay', wasmExports['lv_anim_timeline_get_delay'], 1);
  ...
  _lv_anim_timeline_get_user_data = Module['_lv_anim_timeline_get_user_data'] = createExportWrapper('lv_anim_timeline_get_user_data', wasmExports['lv_anim_timeline_get_user_data'], 1);
  _lv_anim_timeline_merge = Module['_lv_anim_timeline_merge'] = createExportWrapper('lv_anim_timeline_merge', wasmExports['lv_anim_timeline_merge'], 3);
  ...
  _lv_array_remove_unordered = Module['_lv_array_remove_unordered'] = createExportWrapper('lv_array_remove_unordered', wasmExports['lv_array_remove_unordered'], 2);
  ...
  _lv_event_stop_trickling = Module['_lv_event_stop_trickling'] = createExportWrapper('lv_event_stop_trickling', wasmExports['lv_event_stop_trickling'], 1);
  ...
  _lv_fs_get_buffer_from_path = Module['_lv_fs_get_buffer_from_path'] = createExportWrapper('lv_fs_get_buffer_from_path', wasmExports['lv_fs_get_buffer_from_path'], 3);
  _lv_fs_make_path_from_buffer = Module['_lv_fs_make_path_from_buffer'] = createExportWrapper('lv_fs_make_path_from_buffer', wasmExports['lv_fs_make_path_from_buffer'], 5);
  ...
  _lv_fs_get_size = Module['_lv_fs_get_size'] = createExportWrapper('lv_fs_get_size', wasmExports['lv_fs_get_size'], 2);
  _lv_fs_path_get_size = Module['_lv_fs_path_get_size'] = createExportWrapper('lv_fs_path_get_size', wasmExports['lv_fs_path_get_size'], 2);
  _lv_fs_load_to_buf = Module['_lv_fs_load_to_buf'] = createExportWrapper('lv_fs_load_to_buf', wasmExports['lv_fs_load_to_buf'], 3);
  _lv_fs_load_with_alloc = Module['_lv_fs_load_with_alloc'] = createExportWrapper('lv_fs_load_with_alloc', wasmExports['lv_fs_load_with_alloc'], 2);
  ...
  _lv_fs_remove_drive = Module['_lv_fs_remove_drive'] = createExportWrapper('lv_fs_remove_drive', wasmExports['lv_fs_remove_drive'], 1);
  ...
  _lv_fs_path_join = Module['_lv_fs_path_join'] = createExportWrapper('lv_fs_path_join', wasmExports['lv_fs_path_join'], 4);
  ...
  _lv_grad_linear_init = Module['_lv_grad_linear_init'] = createExportWrapper('lv_grad_linear_init', wasmExports['lv_grad_linear_init'], 6);
  _lv_grad_radial_init = Module['_lv_grad_radial_init'] = createExportWrapper('lv_grad_radial_init', wasmExports['lv_grad_radial_init'], 6);
  _lv_grad_conical_init = Module['_lv_grad_conical_init'] = createExportWrapper('lv_grad_conical_init', wasmExports['lv_grad_conical_init'], 6);
  _lv_grad_radial_set_focal = Module['_lv_grad_radial_set_focal'] = createExportWrapper('lv_grad_radial_set_focal', wasmExports['lv_grad_radial_set_focal'], 4);
  ...
  _lv_pending_create = Module['_lv_pending_create'] = createExportWrapper('lv_pending_create', wasmExports['lv_pending_create'], 2);
  _lv_pending_destroy = Module['_lv_pending_destroy'] = createExportWrapper('lv_pending_destroy', wasmExports['lv_pending_destroy'], 1);
  _lv_pending_remove_all = Module['_lv_pending_remove_all'] = createExportWrapper('lv_pending_remove_all', wasmExports['lv_pending_remove_all'], 1);
  _lv_pending_set_free_cb = Module['_lv_pending_set_free_cb'] = createExportWrapper('lv_pending_set_free_cb', wasmExports['lv_pending_set_free_cb'], 3);
  _lv_pending_add = Module['_lv_pending_add'] = createExportWrapper('lv_pending_add', wasmExports['lv_pending_add'], 2);
  _lv_pending_swap = Module['_lv_pending_swap'] = createExportWrapper('lv_pending_swap', wasmExports['lv_pending_swap'], 1);
  ...
  _lv_style_merge = Module['_lv_style_merge'] = createExportWrapper('lv_style_merge', wasmExports['lv_style_merge'], 2);
  ...
  _lv_style_set_image_colorkey = Module['_lv_style_set_image_colorkey'] = createExportWrapper('lv_style_set_image_colorkey', wasmExports['lv_style_set_image_colorkey'], 2);
  ...
  _lv_style_set_blur_radius = Module['_lv_style_set_blur_radius'] = createExportWrapper('lv_style_set_blur_radius', wasmExports['lv_style_set_blur_radius'], 2);
  _lv_style_set_blur_backdrop = Module['_lv_style_set_blur_backdrop'] = createExportWrapper('lv_style_set_blur_backdrop', wasmExports['lv_style_set_blur_backdrop'], 2);
  _lv_style_set_blur_quality = Module['_lv_style_set_blur_quality'] = createExportWrapper('lv_style_set_blur_quality', wasmExports['lv_style_set_blur_quality'], 2);
  _lv_style_set_drop_shadow_radius = Module['_lv_style_set_drop_shadow_radius'] = createExportWrapper('lv_style_set_drop_shadow_radius', wasmExports['lv_style_set_drop_shadow_radius'], 2);
  _lv_style_set_drop_shadow_offset_x = Module['_lv_style_set_drop_shadow_offset_x'] = createExportWrapper('lv_style_set_drop_shadow_offset_x', wasmExports['lv_style_set_drop_shadow_offset_x'], 2);
  _lv_style_set_drop_shadow_offset_y = Module['_lv_style_set_drop_shadow_offset_y'] = createExportWrapper('lv_style_set_drop_shadow_offset_y', wasmExports['lv_style_set_drop_shadow_offset_y'], 2);
  _lv_style_set_drop_shadow_color = Module['_lv_style_set_drop_shadow_color'] = createExportWrapper('lv_style_set_drop_shadow_color', wasmExports['lv_style_set_drop_shadow_color'], 2);
  _lv_style_set_drop_shadow_opa = Module['_lv_style_set_drop_shadow_opa'] = createExportWrapper('lv_style_set_drop_shadow_opa', wasmExports['lv_style_set_drop_shadow_opa'], 2);
  _lv_style_set_drop_shadow_quality = Module['_lv_style_set_drop_shadow_quality'] = createExportWrapper('lv_style_set_drop_shadow_quality', wasmExports['lv_style_set_drop_shadow_quality'], 2);
  ...
  _lv_text_attributes_init = Module['_lv_text_attributes_init'] = createExportWrapper('lv_text_attributes_init', wasmExports['lv_text_attributes_init'], 1);
  ...
  _lv_lock = Module['_lv_lock'] = createExportWrapper('lv_lock', wasmExports['lv_lock'], 0);
  _lv_unlock = Module['_lv_unlock'] = createExportWrapper('lv_unlock', wasmExports['lv_unlock'], 0);
  ...
  _lv_lock_isr = Module['_lv_lock_isr'] = createExportWrapper('lv_lock_isr', wasmExports['lv_lock_isr'], 0);
  _lv_sleep_ms = Module['_lv_sleep_ms'] = createExportWrapper('lv_sleep_ms', wasmExports['lv_sleep_ms'], 1);
  ...
  _lv_theme_create = Module['_lv_theme_create'] = createExportWrapper('lv_theme_create', wasmExports['lv_theme_create'], 0);
  _lv_theme_delete = Module['_lv_theme_delete'] = createExportWrapper('lv_theme_delete', wasmExports['lv_theme_delete'], 1);
  _lv_theme_copy = Module['_lv_theme_copy'] = createExportWrapper('lv_theme_copy', wasmExports['lv_theme_copy'], 2);
  ...
  _lv_tick_get_cb = Module['_lv_tick_get_cb'] = createExportWrapper('lv_tick_get_cb', wasmExports['lv_tick_get_cb'], 0);
  ...
  _lv_arc_set_min_value = Module['_lv_arc_set_min_value'] = createExportWrapper('lv_arc_set_min_value', wasmExports['lv_arc_set_min_value'], 2);
  _lv_arc_set_max_value = Module['_lv_arc_set_max_value'] = createExportWrapper('lv_arc_set_max_value', wasmExports['lv_arc_set_max_value'], 2);
  ...
  _lv_arc_get_change_rate = Module['_lv_arc_get_change_rate'] = createExportWrapper('lv_arc_get_change_rate', wasmExports['lv_arc_get_change_rate'], 1);
  ...
  _lv_arclabel_create = Module['_lv_arclabel_create'] = createExportWrapper('lv_arclabel_create', wasmExports['lv_arclabel_create'], 1);
  _lv_arclabel_set_text = Module['_lv_arclabel_set_text'] = createExportWrapper('lv_arclabel_set_text', wasmExports['lv_arclabel_set_text'], 2);
  _lv_arclabel_set_text_fmt = Module['_lv_arclabel_set_text_fmt'] = createExportWrapper('lv_arclabel_set_text_fmt', wasmExports['lv_arclabel_set_text_fmt'], 3);
  _lv_arclabel_set_text_static = Module['_lv_arclabel_set_text_static'] = createExportWrapper('lv_arclabel_set_text_static', wasmExports['lv_arclabel_set_text_static'], 2);
  _lv_arclabel_set_angle_start = Module['_lv_arclabel_set_angle_start'] = createExportWrapper('lv_arclabel_set_angle_start', wasmExports['lv_arclabel_set_angle_start'], 2);
  _lv_arclabel_set_angle_size = Module['_lv_arclabel_set_angle_size'] = createExportWrapper('lv_arclabel_set_angle_size', wasmExports['lv_arclabel_set_angle_size'], 2);
  _lv_arclabel_set_offset = Module['_lv_arclabel_set_offset'] = createExportWrapper('lv_arclabel_set_offset', wasmExports['lv_arclabel_set_offset'], 2);
  _lv_arclabel_set_dir = Module['_lv_arclabel_set_dir'] = createExportWrapper('lv_arclabel_set_dir', wasmExports['lv_arclabel_set_dir'], 2);
  _lv_arclabel_set_recolor = Module['_lv_arclabel_set_recolor'] = createExportWrapper('lv_arclabel_set_recolor', wasmExports['lv_arclabel_set_recolor'], 2);
  _lv_arclabel_set_radius = Module['_lv_arclabel_set_radius'] = createExportWrapper('lv_arclabel_set_radius', wasmExports['lv_arclabel_set_radius'], 2);
  _lv_arclabel_set_center_offset_x = Module['_lv_arclabel_set_center_offset_x'] = createExportWrapper('lv_arclabel_set_center_offset_x', wasmExports['lv_arclabel_set_center_offset_x'], 2);
  _lv_arclabel_set_center_offset_y = Module['_lv_arclabel_set_center_offset_y'] = createExportWrapper('lv_arclabel_set_center_offset_y', wasmExports['lv_arclabel_set_center_offset_y'], 2);
  _lv_arclabel_set_text_vertical_align = Module['_lv_arclabel_set_text_vertical_align'] = createExportWrapper('lv_arclabel_set_text_vertical_align', wasmExports['lv_arclabel_set_text_vertical_align'], 2);
  _lv_arclabel_set_text_horizontal_align = Module['_lv_arclabel_set_text_horizontal_align'] = createExportWrapper('lv_arclabel_set_text_horizontal_align', wasmExports['lv_arclabel_set_text_horizontal_align'], 2);
  _lv_arclabel_set_overflow = Module['_lv_arclabel_set_overflow'] = createExportWrapper('lv_arclabel_set_overflow', wasmExports['lv_arclabel_set_overflow'], 2);
  _lv_arclabel_set_end_overlap = Module['_lv_arclabel_set_end_overlap'] = createExportWrapper('lv_arclabel_set_end_overlap', wasmExports['lv_arclabel_set_end_overlap'], 2);
  _lv_arclabel_get_angle_start = Module['_lv_arclabel_get_angle_start'] = createExportWrapper('lv_arclabel_get_angle_start', wasmExports['lv_arclabel_get_angle_start'], 1);
  _lv_arclabel_get_angle_size = Module['_lv_arclabel_get_angle_size'] = createExportWrapper('lv_arclabel_get_angle_size', wasmExports['lv_arclabel_get_angle_size'], 1);
  _lv_arclabel_get_dir = Module['_lv_arclabel_get_dir'] = createExportWrapper('lv_arclabel_get_dir', wasmExports['lv_arclabel_get_dir'], 1);
  _lv_arclabel_get_recolor = Module['_lv_arclabel_get_recolor'] = createExportWrapper('lv_arclabel_get_recolor', wasmExports['lv_arclabel_get_recolor'], 1);
  _lv_arclabel_get_radius = Module['_lv_arclabel_get_radius'] = createExportWrapper('lv_arclabel_get_radius', wasmExports['lv_arclabel_get_radius'], 1);
  _lv_arclabel_get_center_offset_x = Module['_lv_arclabel_get_center_offset_x'] = createExportWrapper('lv_arclabel_get_center_offset_x', wasmExports['lv_arclabel_get_center_offset_x'], 1);
  _lv_arclabel_get_center_offset_y = Module['_lv_arclabel_get_center_offset_y'] = createExportWrapper('lv_arclabel_get_center_offset_y', wasmExports['lv_arclabel_get_center_offset_y'], 1);
  _lv_arclabel_get_text_vertical_align = Module['_lv_arclabel_get_text_vertical_align'] = createExportWrapper('lv_arclabel_get_text_vertical_align', wasmExports['lv_arclabel_get_text_vertical_align'], 1);
  _lv_arclabel_get_text_horizontal_align = Module['_lv_arclabel_get_text_horizontal_align'] = createExportWrapper('lv_arclabel_get_text_horizontal_align', wasmExports['lv_arclabel_get_text_horizontal_align'], 1);
  _lv_arclabel_get_overflow = Module['_lv_arclabel_get_overflow'] = createExportWrapper('lv_arclabel_get_overflow', wasmExports['lv_arclabel_get_overflow'], 1);
  _lv_arclabel_get_end_overlap = Module['_lv_arclabel_get_end_overlap'] = createExportWrapper('lv_arclabel_get_end_overlap', wasmExports['lv_arclabel_get_end_overlap'], 1);
  _lv_arclabel_get_text_angle = Module['_lv_arclabel_get_text_angle'] = createExportWrapper('lv_arclabel_get_text_angle', wasmExports['lv_arclabel_get_text_angle'], 1);
  _lv_bar_get_mode = Module['_lv_bar_get_mode'] = createExportWrapper('lv_bar_get_mode', wasmExports['lv_bar_get_mode'], 1);
  _lv_bar_set_min_value = Module['_lv_bar_set_min_value'] = createExportWrapper('lv_bar_set_min_value', wasmExports['lv_bar_set_min_value'], 2);
  ...
  _lv_bar_set_max_value = Module['_lv_bar_set_max_value'] = createExportWrapper('lv_bar_set_max_value', wasmExports['lv_bar_set_max_value'], 2);
  ...
  _lv_bar_bind_value = Module['_lv_bar_bind_value'] = createExportWrapper('lv_bar_bind_value', wasmExports['lv_bar_bind_value'], 2);
  ...
  _lv_calendar_set_today_year = Module['_lv_calendar_set_today_year'] = createExportWrapper('lv_calendar_set_today_year', wasmExports['lv_calendar_set_today_year'], 2);
  _lv_calendar_set_today_month = Module['_lv_calendar_set_today_month'] = createExportWrapper('lv_calendar_set_today_month', wasmExports['lv_calendar_set_today_month'], 2);
  _lv_calendar_set_today_day = Module['_lv_calendar_set_today_day'] = createExportWrapper('lv_calendar_set_today_day', wasmExports['lv_calendar_set_today_day'], 2);
  ...
  _lv_calendar_set_shown_year = Module['_lv_calendar_set_shown_year'] = createExportWrapper('lv_calendar_set_shown_year', wasmExports['lv_calendar_set_shown_year'], 2);
  _lv_calendar_set_shown_month = Module['_lv_calendar_set_shown_month'] = createExportWrapper('lv_calendar_set_shown_month', wasmExports['lv_calendar_set_shown_month'], 2);
  ...
  _lv_chart_set_axis_min_value = Module['_lv_chart_set_axis_min_value'] = createExportWrapper('lv_chart_set_axis_min_value', wasmExports['lv_chart_set_axis_min_value'], 3);
  _lv_chart_set_axis_max_value = Module['_lv_chart_set_axis_max_value'] = createExportWrapper('lv_chart_set_axis_max_value', wasmExports['lv_chart_set_axis_max_value'], 3);
  ...
  _lv_chart_set_hor_div_line_count = Module['_lv_chart_set_hor_div_line_count'] = createExportWrapper('lv_chart_set_hor_div_line_count', wasmExports['lv_chart_set_hor_div_line_count'], 2);
  _lv_chart_set_ver_div_line_count = Module['_lv_chart_set_ver_div_line_count'] = createExportWrapper('lv_chart_set_ver_div_line_count', wasmExports['lv_chart_set_ver_div_line_count'], 2);
  ...
  _lv_chart_get_update_mode = Module['_lv_chart_get_update_mode'] = createExportWrapper('lv_chart_get_update_mode', wasmExports['lv_chart_get_update_mode'], 1);
  _lv_chart_get_hor_div_line_count = Module['_lv_chart_get_hor_div_line_count'] = createExportWrapper('lv_chart_get_hor_div_line_count', wasmExports['lv_chart_get_hor_div_line_count'], 1);
  _lv_chart_get_ver_div_line_count = Module['_lv_chart_get_ver_div_line_count'] = createExportWrapper('lv_chart_get_ver_div_line_count', wasmExports['lv_chart_get_ver_div_line_count'], 1);
  ...
  _lv_chart_remove_cursor = Module['_lv_chart_remove_cursor'] = createExportWrapper('lv_chart_remove_cursor', wasmExports['lv_chart_remove_cursor'], 2);
  ...
  _lv_dropdown_set_text_static = Module['_lv_dropdown_set_text_static'] = createExportWrapper('lv_dropdown_set_text_static', wasmExports['lv_dropdown_set_text_static'], 2);
  ...
  _lv_image_set_pivot_x = Module['_lv_image_set_pivot_x'] = createExportWrapper('lv_image_set_pivot_x', wasmExports['lv_image_set_pivot_x'], 2);
  _lv_image_set_pivot_y = Module['_lv_image_set_pivot_y'] = createExportWrapper('lv_image_set_pivot_y', wasmExports['lv_image_set_pivot_y'], 2);
  ...
  _lv_image_bind_src = Module['_lv_image_bind_src'] = createExportWrapper('lv_image_bind_src', wasmExports['lv_image_bind_src'], 2);
  _lv_imagebutton_set_src_left = Module['_lv_imagebutton_set_src_left'] = createExportWrapper('lv_imagebutton_set_src_left', wasmExports['lv_imagebutton_set_src_left'], 3);
  _lv_imagebutton_set_src_right = Module['_lv_imagebutton_set_src_right'] = createExportWrapper('lv_imagebutton_set_src_right', wasmExports['lv_imagebutton_set_src_right'], 3);
  _lv_imagebutton_set_src_mid = Module['_lv_imagebutton_set_src_mid'] = createExportWrapper('lv_imagebutton_set_src_mid', wasmExports['lv_imagebutton_set_src_mid'], 3);
  ...
  _lv_label_set_text_vfmt = Module['_lv_label_set_text_vfmt'] = createExportWrapper('lv_label_set_text_vfmt', wasmExports['lv_label_set_text_vfmt'], 3);
  ...
  _lv_led_get_color = Module['_lv_led_get_color'] = createExportWrapper('lv_led_get_color', wasmExports['lv_led_get_color'], 2);
  ...
  _lv_menu_get_mode_header = Module['_lv_menu_get_mode_header'] = createExportWrapper('lv_menu_get_mode_header', wasmExports['lv_menu_get_mode_header'], 1);
  _lv_menu_get_mode_root_back_button = Module['_lv_menu_get_mode_root_back_button'] = createExportWrapper('lv_menu_get_mode_root_back_button', wasmExports['lv_menu_get_mode_root_back_button'], 1);
  ...
  _lv_msgbox_add_text_fmt = Module['_lv_msgbox_add_text_fmt'] = createExportWrapper('lv_msgbox_add_text_fmt', wasmExports['lv_msgbox_add_text_fmt'], 3);
  ...
  _lv_roller_get_option_str = Module['_lv_roller_get_option_str'] = createExportWrapper('lv_roller_get_option_str', wasmExports['lv_roller_get_option_str'], 4);
  ...
  _lv_scale_set_min_value = Module['_lv_scale_set_min_value'] = createExportWrapper('lv_scale_set_min_value', wasmExports['lv_scale_set_min_value'], 2);
  _lv_scale_set_max_value = Module['_lv_scale_set_max_value'] = createExportWrapper('lv_scale_set_max_value', wasmExports['lv_scale_set_max_value'], 2);
  ...
  _lv_scale_set_section_min_value = Module['_lv_scale_set_section_min_value'] = createExportWrapper('lv_scale_set_section_min_value', wasmExports['lv_scale_set_section_min_value'], 3);
  _lv_scale_set_section_max_value = Module['_lv_scale_set_section_max_value'] = createExportWrapper('lv_scale_set_section_max_value', wasmExports['lv_scale_set_section_max_value'], 3);
  ...
  _lv_scale_bind_section_min_value = Module['_lv_scale_bind_section_min_value'] = createExportWrapper('lv_scale_bind_section_min_value', wasmExports['lv_scale_bind_section_min_value'], 3);
  _lv_scale_bind_section_max_value = Module['_lv_scale_bind_section_max_value'] = createExportWrapper('lv_scale_bind_section_max_value', wasmExports['lv_scale_bind_section_max_value'], 3);
  ...
  _lv_slider_set_min_value = Module['_lv_slider_set_min_value'] = createExportWrapper('lv_slider_set_min_value', wasmExports['lv_slider_set_min_value'], 2);
  _lv_slider_set_max_value = Module['_lv_slider_set_max_value'] = createExportWrapper('lv_slider_set_max_value', wasmExports['lv_slider_set_max_value'], 2);
  ...
  _lv_span_set_text_fmt = Module['_lv_span_set_text_fmt'] = createExportWrapper('lv_span_set_text_fmt', wasmExports['lv_span_set_text_fmt'], 3);
  ...
  _lv_spangroup_set_span_text_fmt = Module['_lv_spangroup_set_span_text_fmt'] = createExportWrapper('lv_spangroup_set_span_text_fmt', wasmExports['lv_spangroup_set_span_text_fmt'], 4);
  ...
  _lv_spangroup_bind_span_text = Module['_lv_spangroup_bind_span_text'] = createExportWrapper('lv_spangroup_bind_span_text', wasmExports['lv_spangroup_bind_span_text'], 4);
  ...
  _lv_spinbox_set_digit_count = Module['_lv_spinbox_set_digit_count'] = createExportWrapper('lv_spinbox_set_digit_count', wasmExports['lv_spinbox_set_digit_count'], 2);
  _lv_spinbox_set_dec_point_pos = Module['_lv_spinbox_set_dec_point_pos'] = createExportWrapper('lv_spinbox_set_dec_point_pos', wasmExports['lv_spinbox_set_dec_point_pos'], 2);
  _lv_spinbox_set_min_value = Module['_lv_spinbox_set_min_value'] = createExportWrapper('lv_spinbox_set_min_value', wasmExports['lv_spinbox_set_min_value'], 2);
  _lv_spinbox_set_max_value = Module['_lv_spinbox_set_max_value'] = createExportWrapper('lv_spinbox_set_max_value', wasmExports['lv_spinbox_set_max_value'], 2);
  ...
  _lv_spinbox_get_digit_count = Module['_lv_spinbox_get_digit_count'] = createExportWrapper('lv_spinbox_get_digit_count', wasmExports['lv_spinbox_get_digit_count'], 1);
  _lv_spinbox_get_dec_point_pos = Module['_lv_spinbox_get_dec_point_pos'] = createExportWrapper('lv_spinbox_get_dec_point_pos', wasmExports['lv_spinbox_get_dec_point_pos'], 1);
  _lv_spinbox_get_min_value = Module['_lv_spinbox_get_min_value'] = createExportWrapper('lv_spinbox_get_min_value', wasmExports['lv_spinbox_get_min_value'], 1);
  _lv_spinbox_get_max_value = Module['_lv_spinbox_get_max_value'] = createExportWrapper('lv_spinbox_get_max_value', wasmExports['lv_spinbox_get_max_value'], 1);
  _lv_spinbox_get_digit_step_direction = Module['_lv_spinbox_get_digit_step_direction'] = createExportWrapper('lv_spinbox_get_digit_step_direction', wasmExports['lv_spinbox_get_digit_step_direction'], 1);
  _lv_spinbox_bind_value = Module['_lv_spinbox_bind_value'] = createExportWrapper('lv_spinbox_bind_value', wasmExports['lv_spinbox_bind_value'], 2);
  _lv_spinner_set_anim_duration = Module['_lv_spinner_set_anim_duration'] = createExportWrapper('lv_spinner_set_anim_duration', wasmExports['lv_spinner_set_anim_duration'], 2);
  _lv_spinner_set_arc_sweep = Module['_lv_spinner_set_arc_sweep'] = createExportWrapper('lv_spinner_set_arc_sweep', wasmExports['lv_spinner_set_arc_sweep'], 2);
  _lv_spinner_get_anim_duration = Module['_lv_spinner_get_anim_duration'] = createExportWrapper('lv_spinner_get_anim_duration', wasmExports['lv_spinner_get_anim_duration'], 1);
  _lv_spinner_get_arc_sweep = Module['_lv_spinner_get_arc_sweep'] = createExportWrapper('lv_spinner_get_arc_sweep', wasmExports['lv_spinner_get_arc_sweep'], 1);
  ...
  _lv_tabview_set_tab_text = Module['_lv_tabview_set_tab_text'] = createExportWrapper('lv_tabview_set_tab_text', wasmExports['lv_tabview_set_tab_text'], 3);
  _lv_tabview_get_tab_button = Module['_lv_tabview_get_tab_button'] = createExportWrapper('lv_tabview_get_tab_button', wasmExports['lv_tabview_get_tab_button'], 2);
  ...
  _lv_tabview_get_tab_bar_position = Module['_lv_tabview_get_tab_bar_position'] = createExportWrapper('lv_tabview_get_tab_bar_position', wasmExports['lv_tabview_get_tab_bar_position'], 1);
  ...
  _lv_textarea_set_accepted_chars_static = Module['_lv_textarea_set_accepted_chars_static'] = createExportWrapper('lv_textarea_set_accepted_chars_static', wasmExports['lv_textarea_set_accepted_chars_static'], 2);
...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/post.js
}
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.5.0/../common/post.js
