...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/pre.js
...
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/pre.js
...
var ASM_CONSTS = {
  1205912: ($0) => { startToDebuggerMessage($0); },  
 1205944: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206019: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206094: ($0) => { finishToDebuggerMessage($0); },  
 1206127: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1206157: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1206187: ($0) => { lvglScreenTick($0); },  
 1206211: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1206251: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1206305: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1206359: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1206412: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1206465: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1206518: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1206570: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1206617: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1206650: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1206686: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1206731: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1206837: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1206873: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1206910: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1206950: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1207007: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1207066: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
...
// include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/post.js
}
// end include: E:/eez_studio_project/studio-wasm-libs/lvgl-runtime/v9.4.0/../common/post.js
